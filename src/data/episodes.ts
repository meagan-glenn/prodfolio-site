...
export const episodes: Episode[] = [
  ...
  },
  {
    ...
    takeaways: [
      "The eighteen-dollar license a stranger on Facebook talked Jamme into getting — and what she figured out thirty days later that made her cut the middleman out entirely.",
      "The two-business model Jamme runs on purpose: one funds the other, and has for eight years straight. She's blunt about what that buys her that a single business never could.",
      "A three-hour vendor event and $850 taught Jamme something no product job would have — and it's why she'll argue a candle company builds the same instincts a tech product does.",
      "The number Jamme keeps at the front of her mind while she builds, and the course she's writing from scratch because of it — with something in the curriculum you won't find in any FAA prep.",
      "She skipped the biggest tech event of her career one year because she didn't think she belonged. What happened in the room the year she finally walked in told her more than any pitch meeting could."
    ],
    resourcesMentioned: [
  ...
  },
  {
    ...
    description: "Brendan Doyle would rather hire a great accountant with zero product experience than a great PM with no domain experience. He's not joking, and he defends it — on a team shipping four to five features a week with a roadmap that stops at six months.",
    longDescription: "Brendan Doyle's career is one long thread of accounting: a chartered accountancy in Australia, years at KPMG auditing mining companies and then working in technical accounting, and a stint as the subject matter expert at an accounting software company, where he first sat alongside engineers and designers. He founded a lease accounting company after that, bootstrapped it with a single engineer to hundreds of customers, and sold it in 2025. Two months later he was scrolling Y Combinator's company directory, found Campfire, and applied.\n\nCampfire is the AI-native ERP, and Brendan's team ships four to five features a week across roughly 130 people and 30-plus engineers. He walks Santi and Meagan through why that works: an ERP covers so much surface area that the codebase stays segregated, so the engineer on the Stripe integration and the engineer on Israeli tax compliance may never need to speak. He is just as direct about the cost. When product moves that fast, support and go-to-market can find out a feature exists only after a customer asks for it, and he names fixing that as one of his own priorities.\n\nHe also gets into what he deliberately does not do. His roadmap stops at six months. Some features get built without a single customer conversation, because the output is already specified by a tax authority. He measures what an LLM produces in technical accounting against the KPMG partners he worked under with thirty years of experience. And he lands on hiring, where for a product role at Campfire he would take deep accounting knowledge over product experience, because he thinks the accounting is the harder half to teach.",
    ...
    takeaways: [
      "Brendan would take someone with zero product experience and a deep accounting background over a strong PM without one. He knows it's an extreme position, and he says what he thinks is the harder half to teach.",
      "One feature Brendan is shipping required no customer conversations at all, because someone else had already written the spec. He explains the narrow case where skipping discovery is the right call.",
      "Two engineers at Campfire could go their entire time there without speaking to each other. Brendan explains why that's a property of building an ERP rather than a communication problem.",
      "Roughly 130 people, 30-plus engineers, four to five features a week. Brendan is candid about which part of the company that pace leaves behind first, and what it feels like from the inside.",
      "Brendan spent years around KPMG partners with thirty years in technical accounting. He is specific about where an LLM stops keeping up with that, and how it fails when it does.",
  ...
  },
  {
    ...
    description: "Two years, 32 episodes, and two projects that both end here. Santi and Meagan pull the real Buzzsprout and Prodfolio numbers up live, say plainly why they're stopping while things are still going up, and make the case that a project you close on purpose is a finished one — not a failed one.",
    longDescription: "The Product Pivot started as a LinkedIn DM between two people who were both quietly mentoring product managers on the side and figured the advice deserved a wider audience. Two years, 32 episodes, and more than fifteen senior product leaders later — from Microsoft, Google, and Campfire among others — Santi and Meagan have still never met in person. They are six hours apart. They scheduled around full-time jobs, fractional work, a startup, and a pregnancy, and they kept making it work.\n\nThis finale is the behind-the-scenes episode they never got around to doing. Santi pulls the Buzzsprout dashboard up live and reads the numbers out unrehearsed: north of 1,400 all-time downloads, Apple Podcasts as the runaway top app, fourteen percent of downloads coming out of Asia, and cities on the map that neither of them expected. Meagan walks through the change that moved the needle hardest — rebranding the show as a sub-brand of Prodfolio in early 2026, giving every episode its own page with an embedded player, and watching browser listens go from effectively zero to a real channel.\n\nThen they do the same for Prodfolio, which is closing too. Seventy-plus beta signups against a goal of fifteen, cleared in the first two hours. A November 2025 launch, a thousand-plus portfolio views driven, over a thousand dollars in ARR, eleven public releases with a real changelog. And a straight answer about why they are stopping anyway: monetization was never the point, both of them are prioritizing careers and family in this season, and the call was mutual, because every project they started together they intended to end together.\n\nSanti closes with something she says she needed on the record before the last episode ended — a direct message to women, mothers, and anyone whose season is changing, about how hard she was on herself when this chapter started closing and why stepping back from something you love is not the failure it feels like. The archive stays up. The DMs stay open. Both of them plan to podcast again.",
    youtubeId: "",
    topic: "career",
